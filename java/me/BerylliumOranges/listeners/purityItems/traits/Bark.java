...
public class Bark extends PurityItemAbstract {
	...
	public static final String TRAIT_ID = "[Bark]";
	...
	public String getName() {
		return ChatColor.DARK_GREEN + "Treant";
	}
	...
	public String getToolName() {
		return ChatColor.of(new Color(150, 75, 0)) + "Treant Bark";
	}
	...
	public ItemStack getToolItem() {
		...
		meta.addAttributeModifier(Attribute.GENERIC_ARMOR,
				new AttributeModifier(UUID.randomUUID(), "armor", 8, Operation.ADD_NUMBER, EquipmentSlot.CHEST));
